        ...
        do {
            try {
                ...
                if (m != null) {
                    ...
                    String terminal = msg.substring(8);
                    String new_msg = "message("+nano+","+terminal;
                    m.setContent(new_msg);*/
                    //System.out.println(nano); /* AKKA TO JASON */
                    ...
                    if (propCont != null) {
                        ...
                        //System.out.println(im); /* AKKA TO JASON */
                    }
                }
            } catch (Exception e) {
